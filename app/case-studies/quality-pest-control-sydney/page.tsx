      ...
      <main className="pt-24">
        <article className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <header className="mt-6 border-b border-white/10 pb-6">
            ...
            <h1 className="mt-3 text-balance font-heading text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
              {cs.client}
            </h1>
          ...
          <section className="mt-8">
            <h2 className="font-heading text-lg font-bold text-foreground">The challenge</h2>
            <p className="mt-2 text-pretty text-sm leading-relaxed text-muted-foreground">{cs.challenge}</p>
          </section>

          {/* Approach */}
          <section className="mt-8">
            <h2 className="font-heading text-lg font-bold text-foreground">The approach</h2>
            <p className="mt-2 text-pretty text-sm leading-relaxed text-muted-foreground">{cs.approach}</p>
          </section>

          {/* Solution */}
          <section className="mt-8">
            <h2 className="font-heading text-lg font-bold text-foreground">The solution</h2>
            <p className="mt-2 text-pretty text-sm leading-relaxed text-muted-foreground">{cs.solution}</p>
          </section>
          ...
          <section className="mt-8 space-y-6">
            {cs.sections.map((section) => (
              <div key={section.heading}>
                <h3 className="font-heading text-base font-bold text-foreground">{section.heading}</h3>
          ...
          {/* Results */}
          <section className="mt-8 rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/[0.05] to-transparent p-6 sm:p-7">
            <h2 className="font-heading text-lg font-bold text-foreground">Results</h2>
          ...
          {/* Features */}
          <section className="mt-8">
            <h2 className="font-heading text-lg font-bold text-foreground">What was built</h2>
          ...
          {/* Tech stack */}
          <section className="mt-8">
            <h2 className="font-heading text-lg font-bold text-foreground">Tech stack</h2>
          ...
          <section className="mt-10 border-t border-white/10 pt-8">
            <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
              <div>
                <h2 className="font-heading text-lg font-bold text-foreground">Want a site like this?</h2>
