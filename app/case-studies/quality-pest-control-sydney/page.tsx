      ...
      <main className="pt-24">
        <article className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <header className="mt-8 border-b border-white/10 pb-8">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-gold-gradient px-6 py-3 text-sm font-semibold text-black transition-transform hover:scale-[1.02]"
              >
                View live site
          ...
          <section className="mt-10">
            ...
            <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground">{cs.challenge}</p>
          </section>

          {/* Approach */}
          <section className="mt-10">
            <h2 className="font-heading text-2xl font-bold text-foreground">The approach</h2>
            <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground">{cs.approach}</p>
          </section>

          {/* Solution */}
          <section className="mt-10">
            <h2 className="font-heading text-2xl font-bold text-foreground">The solution</h2>
            <p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground">{cs.solution}</p>
          </section>
          ...
          <section className="mt-10 space-y-10">
            {cs.sections.map((section) => (
              <div key={section.heading}>
                <h3 className="font-heading text-xl font-bold text-foreground">{section.heading}</h3>
                <p className="mt-3 text-pretty text-base leading-relaxed text-muted-foreground">{section.body}</p>
              </div>
            ))}
          </section>

          {/* Results */}
          <section className="mt-12 rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/[0.05] to-transparent p-7 sm:p-9">
            <h2 className="font-heading text-2xl font-bold text-foreground">Results</h2>
          ...
          {/* Features */}
          <section className="mt-10">
            <h2 className="font-heading text-2xl font-bold text-foreground">What was built</h2>
          ...
          {/* Tech stack */}
          <section className="mt-10">
            <h2 className="font-heading text-2xl font-bold text-foreground">Tech stack</h2>
            <div className="mt-4 flex flex-wrap gap-2">
              {cs.techStack.map((tech) => (
                <span key={tech} className="rounded-full border border-white/10 bg-card px-4 py-2 text-sm text-foreground/80">
                  {tech}
                </span>
              ))}
            </div>
          ...
          <section className="mt-14 border-t border-white/10 pt-10">
            <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
              <div>
                <h2 className="font-heading text-2xl font-bold text-foreground">Want a site like this?</h2>
